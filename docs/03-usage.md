...
Results appear. Pick a relevant engineering manager or recruiter at the company.

### Step 4: Connect with DM
Click "Connect" → "Add a note":

Paste the DM from the email:
> Hi there, I noticed Razorpay is hiring for Senior Backend Engineer. I'm a backend engineer working with Python and Django, and I'd love to learn more about the role.

**But personalize it first:** Change "Hi there" to the contact's first name.
